...
<div className='flex flex-col md:flex-row justify-between gap-8 mb-[2rem]'>
              ...
              <div className="flex basis-[15%] gap-7">
                  ...
                  <div>
                        <button onClick={() => setIsModalOpen(true)} className='border-[1px] rounded-xl text-[0.8rem] text-center text-[orange]
                          px-3 py-1 text-[0.9rem] bg-[#000] text-white'>Add Product</button>
                  </div>
              </div>
