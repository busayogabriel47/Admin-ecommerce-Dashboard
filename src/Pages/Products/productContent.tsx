...
function ProductContent() {
  ...
  return (
    ...
    <>
        <div className="mt-5">
            <div className="flex flex-col md:flex-row gap-[4%] mt-[5rem]">
                <div className="md:w-[20%] shadow-md">
                    ...
                    <button className='border-[1px] rounded-xl text-[0.8rem] text-center text-[orange]
                          px-3 py-1 text-[0.9rem] bg-[green] text-white absolute left-[5%] bottom-[65%]'>
                            In stock
                    </button>
                    <div className="p-5">
                        <div>
                ...
                <div className="md:w-[20%] shadow-md">
                    ...
                    <button className='border-[1px] rounded-xl text-[0.8rem] text-center text-[orange]
                          px-3 py-1 text-[0.9rem] bg-[green] text-white absolute ml-[2%] bottom-[65%]'>
                            In stock
                    </button>
                    <div className="p-5">
                        <div>
        ...
        <div className="mt-5">
            <div className="flex flex-col md:flex-row gap-[4%] mt-[5rem]">
                <div className="md:w-[20%] shadow-md">
                    <img src={beanFive} className="relative"/>
                    <button className='border-[1px] rounded-xl text-[0.8rem] text-center text-[orange]
                          px-3 py-1 text-[0.9rem] bg-[green] text-white absolute left-[5%] bottom-[65%]'>
                            In stock
                    </button>
                ...
                <div className="md:w-[20%] shadow-md">
                    <img src={beanSix} className="relative"/>
                    <button className='border-[1px] rounded-xl text-[0.8rem] text-center text-[orange]
                          px-3 py-1 text-[0.9rem] bg-[green] text-white absolute ml-[2%] bottom-[65%]'>
                            Add Product
                    </button>
