...
const EditCategoryModal = ({ category, onClose, onUpdate }) => {
  ...
  // Update formData when the category prop changes
  useEffect(() => {
    setFormData({
      name: category.name || "",
      image: null, // Reset the image when a new category is selected
    });
  }, [category]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (updatedCategory) {
        onUpdate(updatedCategory); // Update parent component
